...
Extensions, custom apps and Spicetify Creator are v2 concepts. They still work with v2 and their guides are in the [legacy section](/docs/legacy); in v3 all three are modules. [What changes in v3](/docs/whats-new) maps the old model onto the new one.
