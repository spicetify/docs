...
For built-in extensions that ship with Spicetify (like Full App Display, Keyboard Shortcuts, etc.), see the **[Extensions](/docs/customization/extensions)** page for manual installation instructions.
